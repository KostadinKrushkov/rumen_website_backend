...
class Config:
    STATIC_IP_ADDRESS = '213.91.236.76'
    DEBUG = True
    ...
    DB_USER = 'sa' if DEBUG else os.environ.get('DB_USER')
    DB_SERVER = 'localhost, 1433' if DEBUG else os.environ.get('DB_SERVER')
    ...
    HOME_PICTURES_PATH = 'project/flask/blueprints/picture/home_displayed_pictures.txt'
