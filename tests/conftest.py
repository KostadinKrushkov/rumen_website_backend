...
def client():
    ...
    with app.test_client() as client:
        ...
        client.set_cookie('localhost', 'token', user_context.get('token'))
        yield client
...
def reset_database_and_setup_users():
    ...
    send_register_user_request(starting_client, admin_user_dict)
    send_register_user_request(starting_client, normal_user_dict)
...
def login_normal_user(test_client):
    ...
    return send_login_user_request(test_client, admin_user_dict)
